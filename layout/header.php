            ...
            <div class="container">
                <div class="d-flex flex-wrap align-items-center justify-content-center justify-content-lg-start">
                    <a href="index.php" class="d-flex align-items-center my-2 my-lg-0 me-lg-auto text-white text-decoration-none">
                        ...
                        <img src="img/12323.PNG">
                        <div class='title'>Born to Learn</div>
                    </a>
                    ...
                    <ul class="nav col-12 col-lg-auto my-2 justify-content-center my-md-0 text-small">
                        ...
                        <li>
                            <a href="index.php?controller=admin&action=login" class="nav-link text-white">
                                <svg class="bi d-block mx-auto mb-1" width="24" height="24">
        ...
        <div class="px-3 py-2 border-bottom mb-3">
            <div class="container d-flex flex-wrap justify-content-center">
                ...
                if (!isset($_SESSION['user'])) : ?>
                    <div class="text-end">
                        <a href="index.php?controller=user&action=signin" class="btn btn-primary">Login</a>
                        <a href="index.php?controller=user&action=signup" class="btn btn-primary">Sign up</a>
                    </div>
                <?php else : ?>
                    <div class="text-end">
                        ...
                        <div class="dropdown">
                            ...
                            <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton1">
                                <li><a class="dropdown-item" href="index.php?controller=user&action=setting">Setting</a></li>
